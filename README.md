...
<p>
Due to file size constraints, the full dataset is hosted externally.
</p>

<h4>Dataset Access</h4>
<p>
🔗 <strong>Google Drive Dataset Link</strong><br>
(https://drive.google.com/file/d/1PJdV1crjzTQNlG1rO28Y5xoaIlwBI1ZY/view?usp=sharing)
</p>
...
<h2>Results & Visual Analysis</h2>
<p>
The clustering analysis revealed clear customer segments with distinct
purchasing characteristics, including:
</p>

<ul>
  <li>High-value, frequent purchasers</li>
  <li>Low-frequency, low-spend customers</li>
  <li>Moderate-value but high-diversity buyers</li>
</ul>
...
├── src/                  → Python scripts
│   └── sales_transactions_pca_umap_k_means.py
├── outputs/              → Visualisations and clustering results
└── README.md
</pre>
